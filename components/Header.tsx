...
import { Menu, X, Instagram, Phone, Github, Mail } from 'lucide-react'
        ...
        <header className="bg-gradient-to-r from-sky-900 to-cyan-700">
            <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
                ...
                <ul className={`${isMenuOpen ? 'block' : 'hidden'} md:flex md:space-x-4 absolute md:relative top-16 md:top-0 left-0 right-0 bg-gradient-to-r from-sky-900 to-cyan-700 md:bg-none  md:shadow-none p-4 md:p-0 z-20 gap-1`}>
                    ...
                    <li><Link href="https://www.github.com/aldinokhalifah" className="block py-2 md:py-0 text-white hover:text-red-500">
                    <div className="group flex relative">
                        <p className='text-sm  absolute bg-white p-1 -top-6 left-1/2 transform -translate-x-1/2 hidden lg:group-hover:block  text-red-500  rounded-lg transition-all duration-700 shadow-sm'>Github</p>
